...
export const TOOLS: ToolDefinition[] = [
    ...
    },
    {
        ...
        description: 'Get students with attendance above/at a given percentage threshold',
        input_schema: {
            type: 'object',
            properties: { threshold: { type: 'number', description: 'Percentage threshold, default 75' } },
        },
...
export const executeTool = async (toolName: string, input: any, user: AppUser): Promise<any> => {
    switch (toolName) {
        ...
        case 'get_high_attendance_students':
            return attendanceService.fetchAboveThresholdStudents(input.threshold || 75);

...
const AgentChat = () => {
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            setMessages((prev) => [
                ...prev,
                { role: 'assistant', text: res.data.reply, pendingConfirmation: res.data.pendingConfirmation },
            ]);
        } catch (err) {
    ...
    const handleConfirm = async (confirmed: boolean) => {
        ...
        try {
            ...
            setMessages((prev) => [...prev, { role: 'assistant', text: 'Failed to process confirmation.' }]);
        } finally {
            setLoading(false);
        }
    };
